    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Desmatamento</h2>
      ...
      <div class="row text-center">
        <div class="col-md-4">
          <span class="fa-stack fa-4x">
            ...
            <i class="fas fa fa-tree fa-stack-1x fa-inverse" aria-hidden="true"></i>
          </span>
          <h4 class="service-heading">Desmatamento</h4>
          <h3 class="numArbor">0</h3>
          <h4 class="text-description">Árvores derrubadas !</h4>
          <p>Amazônia perdeu mais de 2000 árvores por minuto nos últimos 40 anos </p>
        </div>
        <div class="col-md-4">
          <span class="fa-stack fa-4x">
            <i class="fas fa-circle fa-stack-2x text-primary"></i>
        ...
        <div class="row">
          ...
          <div class="col-sm-4">
            <div class="team-member">
              ...
              <h4>Luan Santos</h4>
              <p class="text-muted">develop PHP</p>
              <ul class="list-inline social-buttons">
                <li class="list-inline-item">
                  <a href="#">
                    <i class="fab fa-twitter"></i>
...
<script src='https://ajax.googleapis.com/ajax/libs/jqueryui/1.8.5/jquery-ui.min.js'></script>    
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA5V0MaO6WRvPt5wcM9IssBIVjZqvTc1Y4&callback=initMap"async defer></script>
